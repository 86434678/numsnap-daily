...
describe("API Integration Tests", () => {
  ...
  describe("Admin Operations", () => {
    ...
    test("Admin preview with win-screen option", async () => {
      const res = await authenticatedApi("/api/admin/preview", authToken, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          option: "win-screen",
    ...
    test("Admin preview with paywall option", async () => {
      const res = await authenticatedApi("/api/admin/preview", authToken, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
    ...
    test("Admin preview with post-win-details option", async () => {
      const res = await authenticatedApi("/api/admin/preview", authToken, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          option: "post-win-details",
        }),
      });
      await expectStatus(res, 200, 403);
    });

    test("Admin preview without auth returns 401", async () => {
    ...
    test("Admin preview without option returns 400", async () => {
      const res = await authenticatedApi("/api/admin/preview", authToken, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({}),
    ...
    test("Admin preview with invalid option returns 400", async () => {
      const res = await authenticatedApi("/api/admin/preview", authToken, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
